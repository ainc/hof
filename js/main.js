...
function initGallery(){
	...
	$inductees.isotope({ filter: "*" });
	$('#filters a[data-filter="*"]').css({"color": "#af0a09", "font-size": "26px"});
...
function initGalleryEE(){
	...
	$inducteesEE.isotope({ filter: "*" });
	$('#filtersEE a[data-filter="*"]').css({"color": "#af0a09", "font-size": "26px"});
